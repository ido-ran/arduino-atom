...
export default class ArduinoDevPane {
  constructor (properties) {
    ...
    this.outputTextEditor = this.refs.buildOutputTextEditor
  }
  ...
  render () {
    ...
    return (
      <div className="arduino" style="display:flex; flex-direction:column; height: 400px">
        ...
        <atom-text-editor ref="buildOutputTextEditor" style="height: 312px"></atom-text-editor>
      </div>
    )
  }
  ...
  addOutput(text) {
    this.outputTextEditor.model.insertText('\n' + text)
    this.outputTextEditor.model.scrollToCursorPosition([this.outputTextEditor.model.getLineCount(), 0])
  }

  clearOutput() {
    this.outputTextEditor.model.setText('')
  }
